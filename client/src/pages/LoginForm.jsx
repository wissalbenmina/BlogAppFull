      ...
      <div className="bg-slate-500 border border-violet-500 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-30 relative w-[500px]">
        ...
        <form onSubmit={handleSubmit}>
          <div className="relative my-4">
            ...
            <label
              htmlFor="email"
              className="absolute text-sm duration-300 transform -translate scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-violet-600 peer-focus:dark:text-violet-500 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >
              Your Email
            </label>
          </div>
          ...
          <button
            type="submit"
            className="w-full mb-4 text-[18px] mt-6 rounded-lg bg-primary-color p-2"
          >
            Login
          </button>
